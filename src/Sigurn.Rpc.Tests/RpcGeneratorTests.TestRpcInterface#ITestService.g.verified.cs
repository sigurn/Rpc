...
sealed class ITestService_Adapter : Sigurn.Rpc.Infrastructure.InterfaceAdapter
{
    ...
    protected override string? GetMemberName(RpcTraceOp operation, int memberId)
    {
        switch (operation)
        {
            case RpcTraceOp.MethodCall:
                if (memberId == 0) return @__method_0;
                else if (memberId == 1) return @__method_1;
                else if (memberId == 2) return @__method_2;
                else if (memberId == 3) return @__method_3;
                else if (memberId == 4) return @__method_4;
                else if (memberId == 5) return @__method_5;
                else if (memberId == 6) return @__method_6;
                else if (memberId == 7) return @__method_7;
                else if (memberId == 8) return @__method_8;
                else if (memberId == 9) return @__method_9;
                else if (memberId == 10) return @__method_10;
                else if (memberId == 11) return @__method_11;
                else if (memberId == 12) return @__method_12;
                break;

            case RpcTraceOp.PropertyGet:
            case RpcTraceOp.PropertySet:
                if (memberId == 0) return @__property_0;
                else if (memberId == 1) return @__property_1;
                else if (memberId == 2) return @__property_2;
                else if (memberId == 3) return @__property_3;
                else if (memberId == 4) return @__property_4;
                break;

            case RpcTraceOp.EventAttach:
            case RpcTraceOp.EventDetach:
            case RpcTraceOp.EventRaise:
                if (memberId == 0) return @__event_0;
                else if (memberId == 1) return @__event_1;
                break;
